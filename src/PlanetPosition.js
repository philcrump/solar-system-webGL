...
// (new Date().getTime())
const planetICRF = (planetIndex, unixmillis) =>
{
	const ecliptic = computeEclipticCoordinates(keplerianElements2050, planetIndex, unixmillis);

	return convertToICRF(ecliptic);
};

const planetThreeXYZ = (planetIndex, unixmillis) =>
{
	const icrf = planetICRF(planetIndex, unixmillis);

	return [icrf[0], icrf[2], icrf[1]];
};
...
export {planetICRF, planetThreeXYZ}